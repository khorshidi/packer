...
/**
 * The class {@link Packer} can solve multiple 0/1 knapsack problems that represented in an input file.
 * Every line in input file is a particular 0/1 knapsack problem.
 * The Line pattern is "capacity : (item1.index,item1.weight,€item2.cost) (item1.index,item1.weight,€item2.cost) ..."
